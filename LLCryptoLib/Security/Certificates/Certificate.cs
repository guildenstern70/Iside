...
namespace LLCryptoLib.Security.Certificates
{
    ...
    public class Certificate : ICloneable
    {
        ...
        ///     <paramref name="certificate" /> is a null reference (<b>Nothing</b> in Visual
        ///     Basic).
        /// </exception>
        ...
        /// </summary>
        /// <value>The key algorithm information for this X.509 certificate as a string.</value>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1024:UsePropertiesWhereAppropriate")]
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security",
             "CA2122:DoNotIndirectlyExposeMethodsWithLinkDemands")]
        public string KeyAlgorithm
        {
            get { return Marshal.PtrToStringAnsi(this.m_CertInfo.SignatureAlgorithmpszObjId); }
        }

        /// <summary>
        ///     Returns the serial number of the X.509v3 certificate.
        /// </summary>
        /// <value>The serial number of the X.509 certificate as an array of bytes.</value>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security",
             "CA2122:DoNotIndirectlyExposeMethodsWithLinkDemands")]
        ...
        {
            get { return this.BytesToString(this.SerialNumber); }
        }

        /// <summary>
        ///     Returns the name of the current principal.
        /// </summary>
        /// <value>The name of the current principal..</value>
        ...
        public string Name
        {
            get
            {
                ...
                SspiProvider.CryptDecodeObject(
                    ...
                    new IntPtr(SecurityConstants.X509_UNICODE_NAME), this.m_CertInfo.SubjectpbData,
                    this.m_CertInfo.SubjectcbData, 0, IntPtr.Zero, ref size);
                if (size <= 0)
                ...
                try
                {
                    ...
                    if (
                        SspiProvider.CryptDecodeObject(
                            SecurityConstants.PKCS_7_ASN_ENCODING | SecurityConstants.X509_ASN_ENCODING,
                            new IntPtr(SecurityConstants.X509_UNICODE_NAME), this.m_CertInfo.SubjectpbData,
                            this.m_CertInfo.SubjectcbData, 0, buffer, ref size) == 0)
                        throw new CertificateException("Unable to decode the name of the certificate.");
        ...
        /// <remarks>
        ///     The handle returned by this property should not be closed. If the handle is closed by an external actor, the
        ///     methods of the Certificate object may fail in undocumented ways [for instance, an Access Violation may occur].
        /// </remarks>
        ...
        /// </summary>
        /// <value>
        ///     A CertificateStore instance -or- a null reference (<b>Nothing</b> in Visual Basic) is no store is associated
        ...
        internal CertificateStore Store
        {
            ...
            set
            {
                if (this.m_Store != value)
                    this.m_Chain = null; // force a recreation of the certificate chain, if necessary
                this.m_Store = value;
            }
        }
        ...
        public bool SupportsDataEncryption
        {
            get
            {
                return (this.GetIntendedKeyUsage() == 0) ||
                       ((this.GetIntendedKeyUsage() & SecurityConstants.CERT_DATA_ENCIPHERMENT_KEY_USAGE) != 0);
            }
        }
        ...
        public bool SupportsDigitalSignature
        {
            ...
            {
                return (this.GetIntendedKeyUsage() == 0) ||
                       ((this.GetIntendedKeyUsage() & SecurityConstants.CERT_DIGITAL_SIGNATURE_KEY_USAGE) != 0);
            }
        }
        ...
        ///     An error occurs while retrieving the RSA instance associated with the
        ///     certificate.
        /// </exception>
        ...
        public RSA PrivateKey
        {
            get
            {
                ...
                if (
                    SspiProvider.CryptAcquireCertificatePrivateKey(this.Handle, flags, IntPtr.Zero, ref provider,
                        ref keySpec, ref mustFree) == 0)
                ...
                if ((SspiProvider.CryptFindCertificateKeyProvInfo(this.Handle, flags, IntPtr.Zero) == 0)
                    ||
                    (SspiProvider.CertGetCertificateContextProperty(this.Handle,
                         SecurityConstants.CERT_KEY_PROV_INFO_PROP_ID, null, ref length) == 0))
                ...
                {
                    SspiProvider.CertGetCertificateContextProperty(this.Handle,
                        SecurityConstants.CERT_KEY_PROV_INFO_PROP_ID, buffer, ref length);
                    CRYPT_KEY_PROV_INFO provInfo =
                        (CRYPT_KEY_PROV_INFO) Marshal.PtrToStructure(buffer, typeof(CRYPT_KEY_PROV_INFO));
...
/*					if (SspiProvider.CryptAcquireContext(ref provider, IntPtr.Zero, null, SecurityConstants.PROV_RSA_FULL, flags) == 0) {
                    ...
                    CERT_PUBLIC_KEY_INFO pki = new CERT_PUBLIC_KEY_INFO(this.m_CertInfo);
                    int size = 0;
                    ...
                    rsap.Exponent = this.ConvertIntToByteArray(pkb.pubexp);
...
/*					if (provider != 0)
        ...
        /// <summary>
        ///     Creates a new instance of the <see cref="Certificate" /> class by opening a PFX file and retrieving the first
        ///     certificate from it.
        /// </summary>
        ...
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="file" /> or <paramref name="password" /> is a null reference (
        ...
        ///     <b>true</b> if the private keys associated with the certificates should be marked as
        ///     exportable, <b>false</b> otherwise.
        /// </param>
        /// <returns>One of the certificates in the PFX file.</returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="file" /> or <paramref name="password" /> is a null reference (
        ...
        /// <summary>
        ///     Creates a new instance of the <see cref="Certificate" /> class by opening a certificate file and retrieving the
        ///     first certificate from it.
        /// </summary>
        ...
        /// <summary>
        ///     Creates a new instance of the <see cref="Certificate" /> class by duplicating an existing
        ///     <see cref="X509Certificate" /> instance.
        /// </summary>
        ...
        /// <returns>A Certificate instance.</returns>
        /// <remarks>
        ///     This implementation only reads certificates from PEM files. It does not read the private key from the
        ///     certificate file, if one is present.
        /// </remarks>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="filename" /> if a null reference (<b>Nothing</b> in Visual
        ///     Basic).
        /// </exception>
        ...
        public static Certificate CreateFromPemFile(byte[] file)
        {
            ...
            return CreateFromCerFile(certBuffer);
        }
        ...
        public string ToString(bool verbose)
        {
            if (verbose)
            {
                return "CERTIFICATE:\r\n" +
                       ...
                       "        Key Algorithm:  " + this.KeyAlgorithm + "\r\n" +
                       "        Serial Number:  " + this.SerialNumberString + "\r\n" +
        ...
        {
            return this.GetCertHash(HashType.Default);
        }
        ...
        public byte[] GetCertHash(HashType type)
        {
            ...
            {
                int size = 256;
                if ((SspiProvider.CertGetCertificateContextProperty(this.Handle, (int) type, hash, ref size) == 0) || (size <= 0) || (size > 256))
        ...
        {
            return this.GetCertHashString(HashType.Default);
        }
        ...
        {
            int length = SspiProvider.CertGetNameString(this.Handle, SecurityConstants.CERT_NAME_SIMPLE_DISPLAY_TYPE, SecurityConstants.CERT_NAME_DISABLE_IE4_UTF8_FLAG | SecurityConstants.CERT_NAME_ISSUER_FLAG, IntPtr.Zero, IntPtr.Zero, 0);
            if (length <= 0)
                throw new CertificateException("An error occurs while requesting the issuer name.");
            IntPtr name = Marshal.AllocHGlobal(length);
            SspiProvider.CertGetNameString(this.Handle, SecurityConstants.CERT_NAME_SIMPLE_DISPLAY_TYPE, SecurityConstants.CERT_NAME_DISABLE_IE4_UTF8_FLAG | SecurityConstants.CERT_NAME_ISSUER_FLAG, IntPtr.Zero, name, length);
        ...
        {
            return SspiProvider.CertGetPublicKeyLength(SecurityConstants.PKCS_7_ASN_ENCODING | SecurityConstants.X509_ASN_ENCODING, new IntPtr(this.m_Context.pCertInfo.ToInt64() + 56));
        }
        ...
        /// <returns>
        ///     An instance of the <see cref="Extension" /> class -or- a null reference (<b>Nothing</b> in Visual Basic) if
        ...
        /// <summary>
        ///     Decodes the specified extension and returns an object of the specified type that is instantiated with the decoded
        ///     bytes.
        /// </summary>
        /// <param name="extension">The certificate extension to decode.</param>
        /// <param name="oid">
        ///     One of the predefined constants specified in the Win32 CryptoAPI. Refer to the documentation of the
        ///     <a href="http://msdn.microsoft.com/library/en-us/security/security/cryptdecodeobject.asp">CryptDecodeObject</a>
        ...
        /// <remarks>
        ///     <p>
        ///         The specified type should have a public constructor that takes an IntPtr and an int as parameters [in that
        ///         order].
        ///         The IntPtr is a pointer to the decoded buffer and the int contains the number of decoded bytes.
        ///         The type should not keep the IntPtr reference after construction of an instance, because the memory is freed
        ///         when the DecodeExtension method returns.
        ///     </p>
        /// </remarks>
        ...
        /// <param name="extension">The certificate extension to decode.</param>
        /// <param name="oid">
        ///     The Object Identifier of the structure. Refer to the documentation of the
        ///     <a href="http://msdn.microsoft.com/library/en-us/security/security/cryptdecodeobject.asp">CryptDecodeObject</a>
        ///     function for more information.
        /// </param>
        /// <param name="returnType">A <see cref="Type" /> instance. See remarks.</param>
        ...
        protected static object DecodeExtension(Extension extension, IntPtr oid, Type returnType)
        {
            ...
            try
            {
                if (SspiProvider.CryptDecodeObject(SecurityConstants.PKCS_7_ASN_ENCODING | SecurityConstants.X509_ASN_ENCODING, oid, extension.EncodedValue, extension.EncodedValue.Length, 0, buffer, ref size) == 0)
                    throw new CertificateException("Could not decode the extension.");
                return Activator.CreateInstance(returnType, buffer, size);
            }
            catch (CertificateException ce)
            {
                throw ce;
        ...
        {
            // returns one or more of the KeyUsage values
            IntPtr buffer = Marshal.AllocHGlobal(4);
            SspiProvider.CertGetIntendedKeyUsage(SecurityConstants.PKCS_7_ASN_ENCODING | SecurityConstants.X509_ASN_ENCODING, this.m_Context.pCertInfo, buffer, 4);
            byte[] mb = new byte[4];
        ...
        public bool HasPrivateKey()
        {
            ...
            int free = 0;
            bool ret = false;
            if (SspiProvider.CryptAcquireCertificatePrivateKey(this.Handle, SecurityConstants.CRYPT_ACQUIRE_COMPARE_KEY_FLAG | SecurityConstants.CRYPT_ACQUIRE_SILENT_FLAG, IntPtr.Zero, ref handle, ref keyspec, ref free) != 0)
            {
                ret = true;
            }
            if (free != 0)
        ...
        /// <remarks>
        ///     If the X.509 certificate hash is an array of more than 4 bytes, any byte after the fourth byte is not seen in
        ...
        /// <returns>
        ///     <b>true</b> if the current Certificate object is equal to the object specified by <paramref name="other" />;
        ///     otherwise, <b>false</b>.
        /// </returns>
        public virtual bool Equals(Certificate other)
        {
            if (other == null)
                return false;
            return SspiProvider.CertCompareCertificate(SecurityConstants.X509_ASN_ENCODING | SecurityConstants.PKCS_7_ASN_ENCODING, this.m_Context.pCertInfo, other.m_Context.pCertInfo) != 0;
        }
        ...
        public override bool Equals(object other)
        {
            try
            {
                return this.Equals((Certificate) other);
            }
            catch
            {
                try
                {
                    return this.Equals((X509Certificate) other);
                }
                catch
                {
                    return false;
        ...
        /// <summary>
        ///     Returns an array of usages consisting of the intersection of the valid usages for all certificates in an array of
        ///     certificates.
        /// </summary>
        /// <param name="certificates">Array of certificates to be checked for valid usage.</param>
        /// <returns>
        ///     An array of valid usages -or- a null reference (<b>Nothing</b> in Visual Basic) if all certificates support
        ///     all usages.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="certificates" /> is a null reference (<b>Nothing</b> in Visual
        ///     Basic).
        /// </exception>
        ...
        /// <param name="withParents">
        ///     <b>true</b> if the parent certificates should be exported too [if possible], <b>false</b>
        ///     otherwise.
        /// </param>
        /// <remarks>If the specified file already exists, the method will throw an exception.</remarks>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="filename" /> or <paramref name="password" /> is a null
        ...
        /// <exception cref="CertificateException">
        ///     An error occurs while exporting the certificate store<br>-or-</br>
        ///     <br>an error occurs while building the certificate chain</br><br>-or-</br>
        ///     <br>an error occurs while creating the store</br><br>-or-</br>
        ///     <br>an error occurs while adding the certificate to the store.</br>
        /// </exception>
        ...
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="password" /> is a null reference (<b>Nothing</b> in Visual
        ///     Basic).
        /// </exception>
        /// <exception cref="CertificateException">
        ///     An error occurs while exporting the certificate store<br>-or-</br>
        ...
        /// </summary>
        /// <param name="withParents">
        ///     <b>true</b> if the parent certificates should be included [if possible], <b>false</b>
        ///     otherwise.
        /// </param>
        ...
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="filename" /> is a null reference (<b>Nothing</b> in Visual
        ///     Basic).
        /// </exception>
        ...
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="rawString" /> if a null reference (<b>Nothing</b> in Visual
        ///     Basic).
        /// </exception>
        /// <exception cref="CertificateException">An error occurs while loading the specified certificate.</exception>
        /// <exception cref="FormatException">
        ///     The length of <paramref name="rawString" /> is less than 4 -or- the length of
        ///     <paramref name="rawString" /> is not an even multiple of 4.
        /// </exception>
        ...
        /// <remarks>
        ///     <p>
        ///         The <paramref name="password" /> can be a null reference (<b>Nothing</b> in Visual Basic) if the private key is
        ///         not encrypted.
        ///     </p>
        ///     <p>The private key will not be exportable.</p>
        /// </remarks>
        /// <exception cref="ArgumentNullException">
        ///     The PVK file is encrypted and <paramref name="password" /> is a null reference
        ///     (<b>Nothing</b> in Visual Basic).
        /// </exception>
        ...
        /// <remarks>
        ///     The <paramref name="password" /> can be a null reference (<b>Nothing</b> in Visual Basic) if the private key
        ///     is not encrypted.
        /// </remarks>
        /// <exception cref="ArgumentNullException">
        ///     The PVK file is encrypted and <paramref name="password" /> is a null reference
        ...
        public void AssociateWithPrivateKey(string pvkFile, string password, bool exportable)
        {
            ...
            if (isEncrypted != 0)
            {
                ...
                byte[] pkb = this.TryDecrypt(blob, 8, blob.Length - 8, key, 16);
                if (pkb == null)
                {
                    // decryption failed, try with an export key
        ...
        /// <returns>
        ///     <b>true</b> if the certificate is not on the CRL and therefore valid, or <b>false</b> if the certificate is on
        ///     the CRL and therefore revoked.
        /// </returns>
