...
namespace LLCryptoLib.Security.Certificates
{
    ...
    public class CertificateStore
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1706:ShortAcronymsShouldBeUppercase",
             MessageId = "Member")] public const string UnTrustedStore = "Disallowed";
        ...
        /// <remarks>
        ///     The handle will not be duplicated; when this CertificateStore instance is garbage collected, the handle will
        ///     be freed.
        /// </remarks>
        ...
        /// <remarks>
        ///     <p>
        ///         If the system store name provided in this parameter is not the name of an existing system store, a new system
        ///         store will be created and used.
        ///     </p>
        ///     <p>
        ...
        public CertificateStore(StoreLocation location, string store)
        {
            ...
            this.m_Handle = SspiProvider.CertOpenStore(new IntPtr(SecurityConstants.CERT_STORE_PROV_SYSTEM_A), 0, 0,
                (int) location, store);
        ...
        {
            this.m_Handle = SspiProvider.CertOpenStore(new IntPtr(SecurityConstants.CERT_STORE_PROV_MEMORY),
                SecurityConstants.X509_ASN_ENCODING | SecurityConstants.PKCS_7_ASN_ENCODING, 0, 0, null);
            if (this.m_Handle == IntPtr.Zero)
        ...
        ///     <i>certs</i> contains at least one object that is not of type
            ...
            : this()
        {
            ...
            while (enm.MoveNext())
            {
                this.AddCertificate((Certificate) enm.Current);
            }
        }
        ...
        ///     <paramref name="buffer" /> is a null reference (<b>Nothing</b> in Visual
        ///     Basic).
        /// </exception>
        ...
        public CertificateStore(byte[] buffer, CertificateStoreType type)
        {
            ...
            this.m_Handle = SspiProvider.CertOpenStoreData(provider,
                SecurityConstants.X509_ASN_ENCODING | SecurityConstants.PKCS_7_ASN_ENCODING, IntPtr.Zero, 0, ref data);
        ...
        ///     methods of the CertificateStore object may fail in undocumented ways [for instance, an Access Violation may occur].
        /// </remarks>
            ...
            try
            {
                if (SspiProvider.PFXIsPFXBlob(ref pPFX) != 0)
                {
                    if (SspiProvider.PFXVerifyPassword(ref pPFX, password, 0) != 0)
                    {
                        ...
                        {
                            throw new CertificateException("Unable to import the PFX file! [error code = " +
        ...
        /// <remarks>
        ///     The provider opens the file and first attempts to read the file as a serialized store, then as a PKCS #7
        ///     signed message, and finally as a single encoded certificate.
        /// </remarks>
        ...
        public static CertificateStore CreateFromCerFile(string file)
        {
            ...
            IntPtr cs = SspiProvider.CertOpenStore(new IntPtr(SecurityConstants.CERT_STORE_PROV_FILENAME_A),
                SecurityConstants.X509_ASN_ENCODING | SecurityConstants.PKCS_7_ASN_ENCODING, 0, 0, file);
            if (cs == IntPtr.Zero)
                throw new CertificateException("An error occurs while opening the specified store.");
        ...
        /// <returns>
        ///     The <see cref="Certificate" /> that comes after <paramref name="previous" /> -or- a null reference (
        ///     <b>Nothing in Visual Basic</b>) if there is no certificate after <paremref name="previous" />.
        /// </returns>
        public Certificate FindCertificate(Certificate previous)
        {
            ...
            IntPtr ret = SspiProvider.CertFindCertificateInStore(this.Handle, SecurityConstants.X509_ASN_ENCODING, 0,
                SecurityConstants.CERT_FIND_ANY, IntPtr.Zero, prev);
        ...
        /// <returns>
        ///     A <see cref="Certificate" /> that has at least one of the specified key usages -or- a null reference (
        ///     <b>Nothing in Visual Basic</b>) if no valid certificate could be found.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="keyUsage" /> is a null reference (<b>Nothing</b> in Visual
        ///     Basic).
        /// </exception>
        ...
        /// <param name="previous">The previous certificate.</param>
        /// <returns>
        ///     The <see cref="Certificate" /> that comes after <paramref name="previous" /> and that has at least one of the
        ///     specified key usages -or- a null reference (<b>Nothing in Visual Basic</b>) if no other valid certificate could be
        ///     found.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="keyUsage" /> is a null reference (<b>Nothing</b> in Visual
        ...
        public Certificate FindCertificateByUsage(string[] keyUsage, Certificate previous)
        {
            ...
            if (previous == null)
                ...
                prev = SspiProvider.CertDuplicateCertificateContext(previous.Handle);
            IntPtr ret = SspiProvider.CertFindUsageCertificateInStore(this.Handle,
                SecurityConstants.X509_ASN_ENCODING | SecurityConstants.PKCS_7_ASN_ENCODING, 0,
                SecurityConstants.CERT_FIND_CTL_USAGE, ref usage, prev);
        ...
        /// <returns>
        ///     The <see cref="Certificate" /> with the matching default hash -or- a null reference (<b>Nothing</b> in Visual
        ///     Basic) if no certificate with that hash could be found in the store.
        /// </returns>
        ...
        {
            return this.FindCertificateByHash(hash, HashType.Default);
        }
        ...
        /// <returns>
        ///     The <see cref="Certificate" /> with the matching hash -or- a null reference (<b>Nothing</b> in Visual Basic)
        ///     if no certificate with that hash could be found in the store.
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="hash" /> is a null reference (<b>Nothing</b> in Visual Basic).</exception>
        public Certificate FindCertificateByHash(byte[] hash, HashType hashType)
        {
            ...
            IntPtr cert = SspiProvider.CertFindDataBlobCertificateInStore(this.Handle,
                SecurityConstants.X509_ASN_ENCODING | SecurityConstants.PKCS_7_ASN_ENCODING, 0, findType, ref data,
                IntPtr.Zero);
            Marshal.FreeHGlobal(data.pbData);
            if (cert == IntPtr.Zero)
                return null;
        ...
        /// <returns>
        ///     The <see cref="Certificate" /> with the matching key identifier -or- a null reference (<b>Nothing</b> in
        ///     Visual Basic) if no matching certificate could be found in the store.
        /// </returns>
        ...
        public Certificate FindCertificateByKeyIdentifier(byte[] keyID)
        {
            ...
            IntPtr cert = SspiProvider.CertFindDataBlobCertificateInStore(this.Handle,
                SecurityConstants.X509_ASN_ENCODING | SecurityConstants.PKCS_7_ASN_ENCODING, 0,
                SecurityConstants.CERT_FIND_KEY_IDENTIFIER, ref data, IntPtr.Zero);
            Marshal.FreeHGlobal(data.pbData);
            if (cert == IntPtr.Zero)
                return null;
            return new Certificate(cert);
        ...
        /// <returns>
        ///     A <see cref="Certificate" /> with a matching subject name -or- a null reference (<b>Nothing</b> in Visual
        ///     Basic) if no matching certificate could be found in the store.
        /// </returns>
        ...
        public Certificate FindCertificateBySubjectName(string name, Certificate previous)
        {
            ...
            DataBlob data = new DataBlob();
            if (
                SspiProvider.CertStrToName(SecurityConstants.X509_ASN_ENCODING | SecurityConstants.PKCS_7_ASN_ENCODING,
                    name, SecurityConstants.CERT_X500_NAME_STR, IntPtr.Zero, IntPtr.Zero, ref data.cbData, IntPtr.Zero) ==
                0)
                throw new CertificateException(
                    "Could not encode the specified string. [is the string a valid X500 string?]");
            data.pbData = Marshal.AllocHGlobal(data.cbData);
            try
            {
                if (
                    SspiProvider.CertStrToName(
                        SecurityConstants.X509_ASN_ENCODING | SecurityConstants.PKCS_7_ASN_ENCODING, name,
                        SecurityConstants.CERT_X500_NAME_STR, IntPtr.Zero, data.pbData, ref data.cbData, IntPtr.Zero) ==
                    0)
                    throw new CertificateException("Could not encode the specified string.");
                cert = SspiProvider.CertFindDataBlobCertificateInStore(this.Handle,
                    SecurityConstants.X509_ASN_ENCODING | SecurityConstants.PKCS_7_ASN_ENCODING, 0,
                    SecurityConstants.CERT_FIND_SUBJECT_NAME, ref data, prev);
            }
            finally
            {
                Marshal.FreeHGlobal(data.pbData);
        ...
        /// <returns>
        ///     A <see cref="Certificate" /> with a matching subject string -or- a null reference (<b>Nothing</b> in Visual
        ///     Basic) if no matching certificate could be found in the store.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="subject" /> is a null reference (<b>Nothing</b> in Visual
        ///     Basic).
        /// </exception>
        ...
        public Certificate FindCertificateBySubjectString(string subject, Certificate previous)
        {
            ...
            if (previous == null)
                ...
                prev = SspiProvider.CertDuplicateCertificateContext(previous.Handle);
            IntPtr cert = SspiProvider.CertFindStringCertificateInStore(this.Handle,
                SecurityConstants.X509_ASN_ENCODING | SecurityConstants.PKCS_7_ASN_ENCODING, 0,
                SecurityConstants.CERT_FIND_SUBJECT_STR_W, subject, prev);
            if (cert == IntPtr.Zero)
                return null;
            return new Certificate(cert);
        }
        ...
        public Certificate[] EnumCertificates()
        {
            ...
            Certificate prev = this.FindCertificate();
            while (prev != null)
            {
                certs.Add(prev);
                prev = this.FindCertificate(prev);
            }
        ...
        {
            ArrayList certs = new ArrayList();
            Certificate prev = this.FindCertificateByUsage(keyUsage);
            while (prev != null)
            {
                certs.Add(prev);
                prev = this.FindCertificateByUsage(keyUsage, prev);
            }
            return (Certificate[]) certs.ToArray(typeof(Certificate));
        }
        ...
        /// <param name="exportPrivateKeys">
        ///     <b>true</b> if the private keys should be exported [if possible], <b>false</b>
        ///     otherwise.
        /// </param>
        ...
        private byte[] GetPfxBuffer(string password, bool exportPrivateKeys)
        {
            ...
            try
            {
                ...
                data.cbData = 0;
                if (
                    SspiProvider.PFXExportCertStoreEx(this.Handle, ref data, password, IntPtr.Zero,
                        exportPrivateKeys ? SecurityConstants.EXPORT_PRIVATE_KEYS : 0) == 0)
        ...
        private byte[] GetCerBuffer(CertificateStoreType type)
        {
            ...
            try
            {
                ...
                data.pbData = IntPtr.Zero;
                if (
                    SspiProvider.CertSaveStore(this.Handle,
                        SecurityConstants.X509_ASN_ENCODING | SecurityConstants.PKCS_7_ASN_ENCODING, (int) type,
                        SecurityConstants.CERT_STORE_SAVE_TO_MEMORY, ref data, 0) == 0)
        ...
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="buffer" /> or <paramref name="filename" /> is a null reference
        ///     (<b>Nothing</b> in Visual Basic).
        /// </exception>
        /// <exception cref="IOException">An error occurs while writing the data.</exception>
        ...
        public void AddCertificate(Certificate cert)
        {
            if (cert == null)
                throw new ArgumentNullException();
            if (
                SspiProvider.CertAddCertificateContextToStore(this.Handle, cert.Handle,
                    SecurityConstants.CERT_STORE_ADD_NEW, IntPtr.Zero) == 0)
            {
        ...
        public void DeleteCertificate(Certificate cert)
        {
            if (cert == null)
                throw new ArgumentNullException();
            Certificate sci = this.FindCertificateByHash(cert.GetCertHash(HashType.SHA1), HashType.SHA1);
            if (sci == null)
                throw new CertificateException("The certificate could not be found in the store.");
            if (SspiProvider.CertDeleteCertificateFromStore(SspiProvider.CertDuplicateCertificateContext(sci.Handle)) ==
                0)
