...
namespace LLCryptoLib.Utils
{
    ...
    public class HexStyler
    {
        ...
        {
            return new[] {"CLASSIC", "MODERN", "UNIX", "SPACE", "NETSCAPE(tm)"};
        }
        ...
        public static HexEnum Recognize(string hexstring)
        {
            ...
            try
            {
                int.Parse(firstTwo, NumberStyles.HexNumber);
            }
        ...
        /// <param name="rhs">An HexStyler object</param>
        /// <returns>
        ///     false if the specified <see cref="T:System.Object"></see> is equal to the current
        ///     <see cref="T:System.Object"></see>; otherwise, true
        /// </returns>
        public static bool operator !=(HexStyler lhs, HexStyler rhs)
        {
            return !(lhs == rhs);
        ...
        /// </summary>
        /// <param name="hexRepr">
        ///     Is a StringBuilder containing a plain bytes representation (in the UNIX form) in lowercase or
        ///     uppercase
        /// </param>
        ...
        ///     return a string in the wanted style.
        /// </summary>
        /// <param name="hexBytesRepr">
        ///     Is a StringBuilder containing a plain bytes representation (in the UNIX form) in lowercase
        ///     or uppercase
        /// </param>
        /// <returns>A string with the wanted style</returns>
        public string Format(string hexBytesRepr)
        {
            return Format(hexBytesRepr, this.Style);
        }
