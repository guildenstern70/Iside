...
namespace LLCryptoLib.Hash
{
    ...
    public class Tiger : BlockHashAlgorithm
    {
        ...
        public override void Initialize()
        {
            lock (this)
            {
                this.accumulator[0] = 0x0123456789ABCDEF;
                this.accumulator[1] = 0xFEDCBA9876543210;
                this.accumulator[2] = 0xF096A5B4C3B2E187;
                base.Initialize();
            }
        }
        ...
        protected override void ProcessBlock(byte[] inputBuffer, int inputOffset)
        {
            lock (this)
            {
                ulong[] workBuffer = Utilities.ByteToULong(inputBuffer, inputOffset, this.BlockSize);
                ulong a = this.accumulator[0];
                ulong b = this.accumulator[1];
                ulong c = this.accumulator[2];

                this.RoundABC(workBuffer[0], 5);
                this.RoundBCA(workBuffer[1], 5);
                this.RoundCAB(workBuffer[2], 5);
                this.RoundABC(workBuffer[3], 5);
                this.RoundBCA(workBuffer[4], 5);
                this.RoundCAB(workBuffer[5], 5);
                this.RoundABC(workBuffer[6], 5);
                this.RoundBCA(workBuffer[7], 5);

                this.Schedule(workBuffer);

                this.RoundCAB(workBuffer[0], 7);
                this.RoundABC(workBuffer[1], 7);
                this.RoundBCA(workBuffer[2], 7);
                this.RoundCAB(workBuffer[3], 7);
                this.RoundABC(workBuffer[4], 7);
                this.RoundBCA(workBuffer[5], 7);
                this.RoundCAB(workBuffer[6], 7);
                this.RoundABC(workBuffer[7], 7);

                this.Schedule(workBuffer);

                this.RoundBCA(workBuffer[0], 9);
                this.RoundCAB(workBuffer[1], 9);
                this.RoundABC(workBuffer[2], 9);
                this.RoundBCA(workBuffer[3], 9);
                this.RoundCAB(workBuffer[4], 9);
                this.RoundABC(workBuffer[5], 9);
                this.RoundBCA(workBuffer[6], 9);
                this.RoundCAB(workBuffer[7], 9);
        ...
        protected override byte[] ProcessFinalBlock(byte[] inputBuffer, int inputOffset, int inputCount)
        {
            lock (this)
            {
                ...
                return Utilities.ULongToByte(this.accumulator);
            }
        }
        ...
        private void RoundABC(ulong x, int mul)
        {
            this.accumulator[2] ^= x;

            int c0 = (int) this.accumulator[2] & 0xFF;
            int c1 = (int) (this.accumulator[2] >> 8) & 0xFF;
            int c2 = (int) (this.accumulator[2] >> 16) & 0xFF;
            int c3 = (int) (this.accumulator[2] >> 24) & 0xFF;
            int c4 = (int) (this.accumulator[2] >> 32) & 0xFF;
            int c5 = (int) (this.accumulator[2] >> 40) & 0xFF;
            int c6 = (int) (this.accumulator[2] >> 48) & 0xFF;
            int c7 = (int) (this.accumulator[2] >> 56);

            this.accumulator[0] -= T1[c0] ^ T2[c2] ^ T3[c4] ^ T4[c6];
            this.accumulator[1] += T4[c1] ^ T3[c3] ^ T2[c5] ^ T1[c7];
            this.accumulator[1] *= (ulong) mul;
        }


        private void RoundBCA(ulong x, int mul)
        {
            this.accumulator[0] ^= x;

            int a0 = (int) this.accumulator[0] & 0xFF;
            int a1 = (int) (this.accumulator[0] >> 8) & 0xFF;
            int a2 = (int) (this.accumulator[0] >> 16) & 0xFF;
            int a3 = (int) (this.accumulator[0] >> 24) & 0xFF;
            int a4 = (int) (this.accumulator[0] >> 32) & 0xFF;
            int a5 = (int) (this.accumulator[0] >> 40) & 0xFF;
            int a6 = (int) (this.accumulator[0] >> 48) & 0xFF;
            int a7 = (int) (this.accumulator[0] >> 56);

            this.accumulator[1] -= T1[a0] ^ T2[a2] ^ T3[a4] ^ T4[a6];
            this.accumulator[2] += T4[a1] ^ T3[a3] ^ T2[a5] ^ T1[a7];
            this.accumulator[2] *= (ulong) mul;
        }


        private void RoundCAB(ulong x, int mul)
        {
            this.accumulator[1] ^= x;

            int b0 = (int) this.accumulator[1] & 0xFF;
            int b1 = (int) (this.accumulator[1] >> 8) & 0xFF;
            int b2 = (int) (this.accumulator[1] >> 16) & 0xFF;
            int b3 = (int) (this.accumulator[1] >> 24) & 0xFF;
            int b4 = (int) (this.accumulator[1] >> 32) & 0xFF;
            int b5 = (int) (this.accumulator[1] >> 40) & 0xFF;
            int b6 = (int) (this.accumulator[1] >> 48) & 0xFF;
            int b7 = (int) (this.accumulator[1] >> 56);

            this.accumulator[2] -= T1[b0] ^ T2[b2] ^ T3[b4] ^ T4[b6];
            this.accumulator[0] += T4[b1] ^ T3[b3] ^ T2[b5] ^ T1[b7];
            this.accumulator[0] *= (ulong) mul;
        }
