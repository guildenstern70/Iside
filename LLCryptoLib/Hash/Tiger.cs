    ...
    public class Tiger : BlockHashAlgorithm
    {
        ...
        override protected void ProcessBlock(byte[] inputBuffer, int inputOffset)
        {
            lock (this)
            {
                ...
                RoundABC(workBuffer[0], 5);
                RoundBCA(workBuffer[1], 5);
                RoundCAB(workBuffer[2], 5);
                RoundABC(workBuffer[3], 5);
                RoundBCA(workBuffer[4], 5);
                RoundCAB(workBuffer[5], 5);
                RoundABC(workBuffer[6], 5);
                RoundBCA(workBuffer[7], 5);

                Schedule(workBuffer);

                RoundCAB(workBuffer[0], 7);
                RoundABC(workBuffer[1], 7);
                RoundBCA(workBuffer[2], 7);
                RoundCAB(workBuffer[3], 7);
                RoundABC(workBuffer[4], 7);
                RoundBCA(workBuffer[5], 7);
                RoundCAB(workBuffer[6], 7);
                RoundABC(workBuffer[7], 7);

                Schedule(workBuffer);

                RoundBCA(workBuffer[0], 9);
                RoundCAB(workBuffer[1], 9);
                RoundABC(workBuffer[2], 9);
                RoundBCA(workBuffer[3], 9);
                RoundCAB(workBuffer[4], 9);
                RoundABC(workBuffer[5], 9);
                RoundBCA(workBuffer[6], 9);
                RoundCAB(workBuffer[7], 9);
        ...
        override protected byte[] ProcessFinalBlock(byte[] inputBuffer, int inputOffset, int inputCount)
        {
            lock (this)
            {
                ...
                return Utilities.ULongToByte(accumulator);
            }
        }
        ...
        private void RoundABC(ulong x, int mul)
        {
            ...
            int c0 = (int)(accumulator[2]) & 0xFF;
            int c1 = (int)(accumulator[2] >> 8) & 0xFF;
            int c2 = (int)(accumulator[2] >> 16) & 0xFF;
            int c3 = (int)(accumulator[2] >> 24) & 0xFF;
            int c4 = (int)(accumulator[2] >> 32) & 0xFF;
            int c5 = (int)(accumulator[2] >> 40) & 0xFF;
            int c6 = (int)(accumulator[2] >> 48) & 0xFF;
            int c7 = (int)(accumulator[2] >> 56);

            accumulator[0] -= T1[c0] ^ T2[c2] ^ T3[c4] ^ T4[c6];
            accumulator[1] += T4[c1] ^ T3[c3] ^ T2[c5] ^ T1[c7];
            accumulator[1] *= (ulong)mul;
        }
        ...
        private void RoundBCA(ulong x, int mul)
        {
            ...
            int a0 = (int)(accumulator[0]) & 0xFF;
            int a1 = (int)(accumulator[0] >> 8) & 0xFF;
            int a2 = (int)(accumulator[0] >> 16) & 0xFF;
            int a3 = (int)(accumulator[0] >> 24) & 0xFF;
            int a4 = (int)(accumulator[0] >> 32) & 0xFF;
            int a5 = (int)(accumulator[0] >> 40) & 0xFF;
            int a6 = (int)(accumulator[0] >> 48) & 0xFF;
            int a7 = (int)(accumulator[0] >> 56);

            accumulator[1] -= T1[a0] ^ T2[a2] ^ T3[a4] ^ T4[a6];
            accumulator[2] += T4[a1] ^ T3[a3] ^ T2[a5] ^ T1[a7];
            accumulator[2] *= (ulong)mul;
        }
        ...
        private void RoundCAB(ulong x, int mul)
        {
            ...
            int b0 = (int)(accumulator[1]) & 0xFF;
            int b1 = (int)(accumulator[1] >> 8) & 0xFF;
            int b2 = (int)(accumulator[1] >> 16) & 0xFF;
            int b3 = (int)(accumulator[1] >> 24) & 0xFF;
            int b4 = (int)(accumulator[1] >> 32) & 0xFF;
            int b5 = (int)(accumulator[1] >> 40) & 0xFF;
            int b6 = (int)(accumulator[1] >> 48) & 0xFF;
            int b7 = (int)(accumulator[1] >> 56);

            accumulator[2] -= T1[b0] ^ T2[b2] ^ T3[b4] ^ T4[b6];
            accumulator[0] += T4[b1] ^ T3[b3] ^ T2[b5] ^ T1[b7];
            accumulator[0] *= (ulong)mul;
        }


        #region Tables
        private static ulong[] T1 = new ulong[] {
        ...
        private static ulong[] T2 = new ulong[] {
        ...
        private static ulong[] T3 = new ulong[] {
        ...
        private static ulong[] T4 = new ulong[] {
