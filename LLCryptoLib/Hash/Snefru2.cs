...
namespace LLCryptoLib.Hash
{
    ...
    public class Snefru2 : BlockHashAlgorithm
    {
            ...
            : base(64 - (param.Length / 8))
        {
            lock (this)
            {
                if (param == null) { throw new ArgumentNullException("param", "The Snefru2Parameters cannot be null."); }
        ...
        override protected byte[] ProcessFinalBlock(byte[] inputBuffer, int inputOffset, int inputCount)
        {
            lock (this)
            {
                ...
                Array.Copy(Utilities.ULongToByte(size, EndianType.BigEndian), 0, temp, (BlockSize - 8), 8);
                ProcessBlock(temp, 0);
