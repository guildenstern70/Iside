    ...
    public class RIPEMD256 : BlockHashAlgorithm
    {
        ...
        public override void Initialize()
        {
            lock (this)
            {
                ...
                this.accumulator[4] = 0x76543210;
                this.accumulator[5] = 0xFEDCBA98;
                this.accumulator[6] = 0x89ABCDEF;
                this.accumulator[7] = 0x01234567;
                base.Initialize();
            }
        }
        ...
        protected override void ProcessBlock(byte[] inputBuffer, int inputOffset)
        {
            lock (this)
            {
                ...
                Ap = this.accumulator[4];
                Bp = this.accumulator[5];
                Cp = this.accumulator[6];
                Dp = this.accumulator[7];
                ...
                this.accumulator[4] += Ap;
                this.accumulator[5] += Bp;
                this.accumulator[6] += Cp;
                this.accumulator[7] += Dp;
            }
        }
