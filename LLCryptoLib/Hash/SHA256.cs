...
namespace LLCryptoLib.Hash
{
    ...
    public class SHA256 : BlockHashAlgorithm
    {
        ...
        public override void Initialize()
        {
            lock (this)
            {
                this.accumulator[0] = 0x6A09E667;
                this.accumulator[1] = 0xBB67AE85;
                this.accumulator[2] = 0x3C6EF372;
                this.accumulator[3] = 0xA54FF53A;
                this.accumulator[4] = 0x510E527F;
                this.accumulator[5] = 0x9B05688C;
                this.accumulator[6] = 0x1F83D9AB;
                this.accumulator[7] = 0x5BE0CD19;
                base.Initialize();
            }
        }
