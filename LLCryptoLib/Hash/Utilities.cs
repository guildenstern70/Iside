...
namespace LLCryptoLib.Hash
{
    ...
    sealed public class Utilities
    {
        ...
        static public ushort RotateRight(ushort x, int shift)
        {
        ...
        static public uint RotateRight(uint x, int shift)
        {
        ...
        static public ulong RotateRight(ulong x, int shift)
        {
        ...
        /// <param name="shift">How many bits to rotate.</param>
        /// <returns>The rotated unsigned short integer.</returns>
        static public ushort RotateLeft(ushort x, int shift)
        {
            return (ushort)((x << shift) | (x >> (16 - shift)));
        }
        ...
        /// <param name="shift">How many bits to rotate.</param>
        /// <returns>The rotated unsigned integer.</returns>
        static public uint RotateLeft(uint x, int shift)
        {
            return (x << shift) | (x >> (32 - shift));
        }
        ...
        /// <param name="shift">How many bits to rotate.</param>
        /// <returns>The rotated unsigned long integer.</returns>
        static public ulong RotateLeft(ulong x, int shift)
        {
            return (x << shift) | (x >> (64 - shift));
        }
    }
