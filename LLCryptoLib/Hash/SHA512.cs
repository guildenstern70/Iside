...
namespace LLCryptoLib.Hash
{
    ...
    public class SHA512 : BlockHashAlgorithm
    {
        ...
        public override void Initialize()
        {
            lock (this)
            {
                this.accumulator[0] = 0x6A09E667F3BCC908;
                this.accumulator[1] = 0xBB67AE8584CAA73B;
                this.accumulator[2] = 0x3C6EF372FE94F82B;
                this.accumulator[3] = 0xA54FF53A5F1D36F1;
                this.accumulator[4] = 0x510E527FADE682D1;
                this.accumulator[5] = 0x9B05688C2B3E6C1F;
                this.accumulator[6] = 0x1F83D9ABFB41BD6B;
                this.accumulator[7] = 0x5BE0CD19137E2179;
                base.Initialize();
            }
        }
        ...
        protected override byte[] ProcessFinalBlock(byte[] inputBuffer, int inputOffset, int inputCount)
        {
            lock (this)
            {
                ...
                return Utilities.ULongToByte(this.accumulator, EndianType.BigEndian);
            }
        }
