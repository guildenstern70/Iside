...
namespace LLCryptoLib.Hash
{
    ...
    public class SHA224 : BlockHashAlgorithm
    {
        ...
        override public void Initialize()
        {
            lock (this)
            {
                accumulator[0] = 0xC1059ED8;
                accumulator[1] = 0x367CD507;
                accumulator[2] = 0x3070DD17;
                accumulator[3] = 0xF70E5939;
                accumulator[4] = 0xFFC00B31;
                accumulator[5] = 0x68581511;
                accumulator[6] = 0x64F98FA7;
                accumulator[7] = 0xBEFA4FA4;
                base.Initialize();
            }
        }
        ...
        override protected byte[] ProcessFinalBlock(byte[] inputBuffer, int inputOffset, int inputCount)
        {
            lock (this)
            {
                ...
                Array.Copy(accumulator, final, 7);
