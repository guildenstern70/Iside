...
namespace LLCryptoLib.Crypto
{
    ...
    internal class TwofishBase
    {
        ...
        *
        ...
        protected void blockEncrypt(ref uint[] x)
        {
            ...
            {
#if FEISTEL
				t0	 = f32(ROR(x[0],  (r)/2),ref sboxKeys,keyLength);
				t1	 = f32(ROL(x[1],8(r)/2),ref sboxKeys,keyLength);
											/* PHT, round keys */
				x[2]^= ROL(t0    t1  subKeys[ROUND_SUBKEYS*r  ], r    /2);
				x[3]^= ROR(t0  2*t1  subKeys[ROUND_SUBKEYS*r],(r) /2);
    ...
    /// <summary>
    /// Twofish encryption algorithm of which more information can be found at http://www.counterpane.com/twofish.html. 
