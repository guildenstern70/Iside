...
namespace LLCryptoLib.Crypto
{
	...
	internal class TextTripleDES : TextAlgorithm
	{
		...
		public override string Code(string txt)
		{
            ...
            System.Diagnostics.Debug.WriteLine(String.Format(Config.NUMBERFORMAT, "TripleDES Encoding with key={0} and block={1}", TextEncryptionUtils.BytesToBase64String(this.maKey), TextEncryptionUtils.BytesToBase64String(this.maIV)));
		...
		public override string Decode(string txt)
		{
            ...
            System.Diagnostics.Debug.WriteLine(String.Format(Config.NUMBERFORMAT, "TripleDES Decoding with key={0} and block={1}", TextEncryptionUtils.BytesToBase64String(this.maKey), TextEncryptionUtils.BytesToBase64String(this.maIV)));
