...
namespace LLCryptoLib.Crypto
{
    ...
    public class AsymmetricCrypter
    {
        ...
        private SupportedStreamAlgorithms ssa;
        ...
        public static RSA LoadKeyFromXmlFile(RSA rsaEncryptor, string publicKeyFile)
        {
            ...
            return AsymmetricCrypter.KeyFromXml(rsaEncryptor, xmlFile);
        ...
        {
            // Generate random key
            string rndKey = LLCryptoLib.Utils.RandomString.Get(RANDOM_KEY_LEN);
