...
namespace AxsUtils.Win32
{
    ...
    public enum RestartOption
    {
        ...
        ///     disk, and all running processes have stopped. If the system supports the power-off feature, the power is also
        ///     turned off.
        /// </summary>
        ShutDown = 1,
    ...
    /// <summary>
    ///     An LUID is a 64-bit value guaranteed to be unique only on the system on which it was generated. The uniqueness of a
    ...
    internal struct LUID_AND_ATTRIBUTES
    {
        ...
        /// <summary>
        ///     Specifies attributes of the LUID. This value contains up to 32 one-bit flags. Its meaning is dependent on the
        ///     definition and use of the LUID.
        /// </summary>
    ...
    internal struct TOKEN_PRIVILEGES
    {
        ...
        /// <summary>
        ///     Specifies an array of LUID_AND_ATTRIBUTES structures. Each structure contains the LUID and attributes of a
        ///     privilege.
        /// </summary>
    ...
    public class WindowsController
    {
        ...
        /// <summary>
        ///     Forces processes to terminate. When this flag is set, the system does not send the WM_QUERYENDSESSION and
        ///     WM_ENDSESSION messages. This can cause the applications to lose data. Therefore, you should only use this flag in
        ///     an emergency.
        /// </summary>
        ...
        ///     Pointer to a null-terminated string that names the executable module (either a .dll or .exe
        ///     file). The name specified is the file name of the module and is not related to the name stored in the library
        ///     module itself, as specified by the LIBRARY keyword in the module-definition (.def) file.
        /// </param>
        /// <returns>
        ///     If the function succeeds, the return value is a handle to the module.<br></br>
        ///     <br>
        ...
        /// <summary>
        ///     The FreeLibrary function decrements the reference count of the loaded dynamic-link library (DLL). When the
        ///     reference count reaches zero, the module is unmapped from the address space of the calling process and the handle
        ///     is no longer valid.
        /// </summary>
        /// <param name="hLibModule">
        ///     Handle to the loaded DLL module. The LoadLibrary or GetModuleHandle function returns this
        ///     handle.
        /// </param>
        /// <returns>
        ///     If the function succeeds, the return value is nonzero.<br></br>
        ///     <br>
        ...
        /// <summary>
        ///     The GetProcAddress function retrieves the address of an exported function or variable from the specified
        ///     dynamic-link library (DLL).
        /// </summary>
        /// <param name="hModule">
        ///     Handle to the DLL module that contains the function or variable. The LoadLibrary or
        ///     GetModuleHandle function returns this handle.
        /// </param>
        /// <param name="lpProcName">
        ///     Pointer to a null-terminated string containing the function or variable name, or the
        ///     function's ordinal value. If this parameter is an ordinal value, it must be in the low-order word; the high-order
        ///     word must be zero.
        /// </param>
        /// <returns>
        ///     If the function succeeds, the return value is the address of the exported function or variable.<br></br>
        ///     <br>
        ///         If the function fails, the return value is NULL. To get extended error information, call
        ///         Marshal.GetLastWin32Error.
        ///     </br>
        ...
        /// <summary>
        ///     The SetSuspendState function suspends the system by shutting power down. Depending on the Hibernate parameter, the
        ///     system either enters a suspend (sleep) state or hibernation (S4). If the ForceFlag parameter is TRUE, the system
        ///     suspends operation immediately; if it is FALSE, the system requests permission from all applications and device
        ///     drivers before doing so.
        /// </summary>
        /// <param name="Hibernate">
        ///     Specifies the state of the system. If TRUE, the system hibernates. If FALSE, the system is
        ///     suspended.
        /// </param>
        /// <param name="ForceCritical">
        ///     Forced suspension. If TRUE, the function broadcasts a PBT_APMSUSPEND event to each
        ///     application and driver, then immediately suspends operation. If FALSE, the function broadcasts a
        ///     PBT_APMQUERYSUSPEND event to each application to request permission to suspend operation.
        /// </param>
        /// <param name="DisableWakeEvent">
        ///     If TRUE, the system disables all wake events. If FALSE, any system wake events remain
        ///     enabled.
        /// </param>
        /// <returns>
        ///     If the function succeeds, the return value is nonzero.<br></br>
        ...
        ///     These requested access types are compared with the token's discretionary access-control list (DACL) to determine
        ...
        ///     Pointer to a null-terminated string specifying the name of the system on which the privilege
        ///     name is looked up. If a null string is specified, the function attempts to find the privilege name on the local
        ///     system.
        /// </param>
        /// <param name="lpName">
        ///     Pointer to a null-terminated string that specifies the name of the privilege, as defined in the
        ///     Winnt.h header file. For example, this parameter could specify the constant SE_SECURITY_NAME, or its corresponding
        ///     string, "SeSecurityPrivilege".
        /// </param>
        /// <param name="lpLuid">
        ///     Pointer to a variable that receives the locally unique identifier by which the privilege is known
        ///     on the system, specified by the lpSystemName parameter.
        /// </param>
        /// <returns>
        ///     If the function succeeds, the return value is nonzero.<br></br>
        ///     <br>
        ...
        /// <summary>
        ///     The AdjustTokenPrivileges function enables or disables privileges in the specified access token. Enabling or
        ///     disabling privileges in an access token requires TOKEN_ADJUST_PRIVILEGES access.
        /// </summary>
        /// <param name="TokenHandle">
        ///     Handle to the access token that contains the privileges to be modified. The handle must have
        ///     TOKEN_ADJUST_PRIVILEGES access to the token. If the PreviousState parameter is not NULL, the handle must also have
        ///     TOKEN_QUERY access.
        /// </param>
        /// <param name="DisableAllPrivileges">
        ///     Specifies whether the function disables all of the token's privileges. If this value
        ///     is TRUE, the function disables all privileges and ignores the NewState parameter. If it is FALSE, the function
        ///     modifies privileges based on the information pointed to by the NewState parameter.
        /// </param>
        /// <param name="NewState">
        ///     Pointer to a TOKEN_PRIVILEGES structure that specifies an array of privileges and their
        ///     attributes. If the DisableAllPrivileges parameter is FALSE, AdjustTokenPrivileges enables or disables these
        ///     privileges for the token. If you set the SE_PRIVILEGE_ENABLED attribute for a privilege, the function enables that
        ///     privilege; otherwise, it disables the privilege. If DisableAllPrivileges is TRUE, the function ignores this
        ///     parameter.
        /// </param>
        ...
        ///     Pointer to a buffer that the function fills with a TOKEN_PRIVILEGES structure that contains
        ///     the previous state of any privileges that the function modifies. This parameter can be NULL.
        /// </param>
        /// <param name="ReturnLength">
        ///     Pointer to a variable that receives the required size, in bytes, of the buffer pointed to by
        ...
        ///     specified privileges, call Marshal.GetLastWin32Error.
        /// </returns>
        ...
        /// <summary>
        ///     The ExitWindowsEx function either logs off the current user, shuts down the system, or shuts down and restarts the
        ///     system. It sends the WM_QUERYENDSESSION message to all applications to determine if they can be terminated.
        /// </summary>
        ...
        /// <summary>
        ///     The FormatMessage function formats a message string. The function requires a message definition as input. The
        ///     message definition can come from a buffer passed into the function. It can come from a message table resource in an
        ...
        /// </summary>
        /// <param name="dwFlags">
        ///     Specifies aspects of the formatting process and how to interpret the lpSource parameter. The
        ///     low-order byte of dwFlags specifies how the function handles line breaks in the output buffer. The low-order byte
        ///     can also specify the maximum width of a formatted output line.
        /// </param>
        /// <param name="lpSource">
        ///     Specifies the location of the message definition. The type of this parameter depends upon the
        ...
        ///     Specifies the language identifier for the requested message. This parameter is ignored if
        ///     dwFlags includes FORMAT_MESSAGE_FROM_STRING.
        /// </param>
        /// <param name="lpBuffer">
        ///     Pointer to a buffer for the formatted (and null-terminated) message. If dwFlags includes
        ...
        /// </param>
        /// <param name="nSize">
        ///     If the FORMAT_MESSAGE_ALLOCATE_BUFFER flag is not set, this parameter specifies the maximum number
        ///     of TCHARs that can be stored in the output buffer. If FORMAT_MESSAGE_ALLOCATE_BUFFER is set, this parameter
        ///     specifies the minimum number of TCHARs to allocate for an output buffer. For ANSI text, this is the number of
        ///     bytes; for Unicode text, this is the number of characters.
        /// </param>
        /// <param name="Arguments">
        ///     Pointer to an array of values that are used as insert values in the formatted message. A %1 in
        ///     the format string indicates the first value in the Arguments array; a %2 indicates the second argument; and so on.
        /// </param>
        /// <returns>
        ///     If the function succeeds, the return value is the number of TCHARs stored in the output buffer, excluding the
        ///     terminating null character.<br></br>
        ///     <br>
        ///         If the function fails, the return value is zero. To get extended error information, call
        ///         Marshal.GetLastWin32Error.
        ///     </br>
        ...
        public static void ExitWindows(RestartOption how, bool force)
        {
            switch (how)
            {
                case RestartOption.Suspend:
                    SuspendSystem(false, force);
                    break;
                case RestartOption.Hibernate:
