...
namespace AxsUtils.Win32
{
    ...
    public class ShellOps
    {
        ...
        private readonly FILEOP_FLAGS fFlags;
        ...
        {
            NativeMethods.SHChangeNotify(HChangeNotifyEventID.SHCNE_ALLEVENTS, HChangeNotifyFlags.SHCNF_IDLIST,
                IntPtr.Zero, IntPtr.Zero);
        }

        public static void ShellChangeDirNotify(string path)
        {
            IntPtr cstrPath = Marshal.StringToHGlobalAnsi(path);
            NativeMethods.SHChangeNotify(HChangeNotifyEventID.SHCNE_UPDATEDIR, HChangeNotifyFlags.SHCNF_PATHA, cstrPath,
                IntPtr.Zero);
        }
        ...
        {
            int hresult = NativeMethods.SHEmptyRecycleBin(IntPtr.Zero, rootPath,
        ...
        public class FILEOP_FLAGS
        {
            ...
            public bool FOF_NOCONFIRMATION;
