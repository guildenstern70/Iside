    ...
    public class UserActivityHook
    {
        ...
        public void Start(bool InstallMouseHook, bool InstallKeyboardHook)
        {
            ...
            if ((this.hMouseHook == 0) && InstallMouseHook)
            {
                ...
                MouseHookProcedure = this.MouseHookProc;
                //install hook
                this.hMouseHook = SetWindowsHookEx(
                    WH_MOUSE_LL,
                    MouseHookProcedure,
            ...
            {
                // Create an instance of HookProc.
                KeyboardHookProcedure = this.KeyboardHookProc;
                //install hook
                this.hKeyboardHook = SetWindowsHookEx(
                    WH_KEYBOARD_LL,
        ...
        public void Stop(bool UninstallMouseHook, bool UninstallKeyboardHook, bool ThrowExceptions)
        {
            ...
            {
                //uninstall hook
                int retMouse = UnhookWindowsHookEx(this.hMouseHook);
            ...
            {
                //uninstall hook
                int retKeyboard = UnhookWindowsHookEx(this.hKeyboardHook);
                //reset invalid handle
        ...
        private int KeyboardHookProc(int nCode, int wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && ((this.KeyDown != null) || (this.KeyUp != null) || (this.KeyPress != null)))
            {
                ...
                //raise KeyDown
                if ((this.KeyDown != null) && ((wParam == WM_KEYDOWN) || (wParam == WM_SYSKEYDOWN)))
                {
                ...
                // raise KeyPress
                if ((this.KeyPress != null) && (wParam == WM_KEYDOWN))
                {
                ...
                // raise KeyUp
                if ((this.KeyUp != null) && ((wParam == WM_KEYUP) || (wParam == WM_SYSKEYUP)))
                {
                    Keys keyData = (Keys) MyKeyboardHookStruct.vkCode;
                    KeyEventArgs e = new KeyEventArgs(keyData);
                    this.KeyUp(this, e);
