...
namespace AxsUtils
{
    ...
    public class DirectoryElements
    {
        ...
        [CLSCompliant(false)]
        public ulong OverallFileSize { get; private set; }
        ...
        private bool BuildList(DirectoryInfo di)
        {
            ...
            try
            {
                foreach (FileInfo fi in di.GetFiles())
                {
                    ...
                    this.Files.Add(fi);
                    this.OverallFileSize += (ulong) fi.Length;
                }
        ...
        private void BuildItemsList()
        {
            ...
            {
                throw new AxsException("Files in the specified directory are in use by another process.");
            }
        }
