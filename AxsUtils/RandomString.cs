...
namespace AxsUtils
{
    ...
    public static class RandomString
    {
        ...
        private const string EXTENDED_ALPHA =
            "abcdefghijklmnopqrstuvwxyz!@#$%^&*()Ë+Ú‡Ï˘Á©°£ø\r\nABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890,.;':[]{}_=";
        ...
        {
            return Get(len, false);
        }

        /// <summary>
        ///     Gets a random string with a random length betwenn minLength and maxLength alphanumeric characters, both uppercase
        ...
        /// <summary>
        ///     Gets a random string with a random length betwenn minLength and maxLength alphanumeric characters, both uppercase
        ///     and lowercase, with symbol and numbers.
        /// </summary>
        /// <param name="minLength">Minimum length of the random string.</param>
        /// <param name="maxLength">Maximum length of the random string.</param>
        /// <returns></returns>
